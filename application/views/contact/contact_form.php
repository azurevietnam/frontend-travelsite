...
<?php endif;?>
  ...
  <div class="form-group">
    <label for="full_name" class="col-sm-2 control-label"><?=lang('full_name')?>: <?=mark_required()?></label>
    <div class="col-xs-2">
  ...
  <div class="form-group">
    <label for="email" class="col-sm-2 control-label"><?=lang('email_address')?>: <?=mark_required()?></label>
    <div class="col-xs-6">
  ...
  <div class="form-group">
    <label for="email_cf" class="col-sm-2 control-label"><?=lang('email_address_confirm')?>: <?=mark_required()?></label>
    <div class="col-xs-6">
   ...
   <div class="form-group">
    <label for="phone" class="col-sm-2 control-label"><?=lang('phone_number')?>: <?=mark_required()?></label>
    <div class="col-xs-6">
   ...
   <div class="form-group">
	    <label for="country" class="col-xs-2 control-label"><?=lang('country')?>: <?=mark_required()?></label>
	    <div class="col-xs-4">
   ...
   <div class="form-group">
   		<label for="city" class="col-xs-2 control-label"><?=lang('city')?>:</label>
	    <div class="col-xs-4">
    ...
    <?php endif;?>
  	...
  	<div class="form-group">
	    <label for="special_requests" class="col-sm-2 control-label"><?=lang('special_requests')?>:</label>
	    <div class="col-xs-6">
  	...
  	<div class="form-group">
	  	<div class="col-xs-12 col-xs-offset-2 text-info">
