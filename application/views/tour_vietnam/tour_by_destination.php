...
<?php if(!empty($tours)):?>
	...
	<h2 class="highlight" style="float: left; padding-bottom: 0; margin-top: 10px;"><span class="icon recommend_icon"></span><?=$tour_list_title?></h2>
		...
		<div class="area_right">			
			...
			<div class="bpt_item_price <?=$tour['id'].'block_price'?>" style="display: none;width: auto;">
				<ul>
					...
					<li class="from <?=$tour['id'].'from_label'?>">from</li>
					<li>
