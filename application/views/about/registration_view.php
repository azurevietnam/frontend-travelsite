...
<a href="javascript:void(0)" rel="nofollow" imgurl="<?=get_static_resources('/media/international_tour_operator_licence_1.jpg')?>" class="highslide" onclick="return hs.expand(this);">
	<img width="200" style="float: left;border:0" src="<?=get_static_resources('/media/international_tour_operator_licence_1.jpg')?>"></img>
</a>
<a href="javascript:void(0)" rel="nofollow" imgurl="<?=get_static_resources('/media/international_tour_operator_licence_2.jpg')?>" class="highslide" onclick="return hs.expand(this);">
	<img width="200" style="float: left;border:0" src="<?=get_static_resources('/media/international_tour_operator_licence_2.jpg')?>"></img>
</a>
</div>
<script>
function async_load(){
