<h1 class="highlight"><?=lang('vietnam_visa_application_form')?></h1>
<ul style="list-style: decimal;" class="list-app-step">
    <li style="font-size: 14px; font-weight: bold;" class="highlight">
    ...
    <li style="font-size: 14px; font-weight: bold;" class="highlight">
        ...
        <div style="font-size: 12px; color: #333; font-weight: normal;">
            ...
            <table class="table table-bordered table-rates margin-bottom-10">
                <thead>
                <tr>
