...
<h1 class="highlight" style="padding-left: 0"><?=lang('tpc_terms_conditions') ?></h1>
	...
	<ul id="overview">
		...
		<li><span class="highlight"><?=lang('tpc_best_price_guaranteed') ?></span>
			<?=lang('tpc_best_price_guaranteed_content') ?>						
		</li>
		
		<li><span class="highlight"><?=lang('tpc_quality_guaranteed') ?></span>
			<?=lang('tpc_quality_guaranteed_content') ?>						
		</li>
