...
<?php if (!empty($tour)):?>
	<div class="col-xs-4 best-seller margin-bottom-10 tour-ids" data-id="<?=$tour[0]['id']?>">
	    ...
	    <div class="best-seller-content">
		    ...
		    <div class="clearfix margin-top-10" style="height: 24px;">    	
	    	...
	    	<div class="row best-seller-price">
	            <div class="col-xs-8 text-left" style="font-size: 14px;">
...
<?php if (!empty($cruise_halong)):?>
	<div class="col-xs-4 best-seller margin-bottom-10 tour-ids" data-id="<?=$cruise_halong[0]['id']?>">
  
    <div class="text-headder" style="background-color: #89bb58;"> <?=lang('halong_bay_cruises')?>  </div>
