...
class GA_Parse
{
  ...
  */
  ...
  $this->first_visit = date(DB_DATE_TIME_FORMAT, $time_initial_visit);

  $this->previous_visit = date(DB_DATE_TIME_FORMAT, $time_beginning_previous_visit);
  
  $this->current_visit_started = date(DB_DATE_TIME_FORMAT, $time_beginning_current_visit);
